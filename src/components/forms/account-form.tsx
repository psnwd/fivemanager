    ...
    <Form {...form}>
      <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-8">
        ...
        <FormField
          ...
          render={({ field }) => (
            <FormItem>
              <FormLabel>Steam GUID</FormLabel>
              <FormControl>
                <Input
                  type="number"
                  placeholder="76561197995364867"
                  {...field}
                />
              </FormControl>
              <FormDescription>
                This is the steam GUID that will be used to identify you in the
                in-game.
              </FormDescription>
              <FormMessage />
            </FormItem>
        ...
        <FormField
          ...
          render={({ field }) => (
            <FormItem>
              ...
              <FormControl>
                <Input placeholder="blackcat@example.com" {...field} />
              </FormControl>
              <FormDescription>
