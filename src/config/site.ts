export const siteConfig = {
  name: "FiveManager",
  description:
    "Welcome to Los Santos RP, the ultimate GTA V roleplay experience! Dive into the chaotic, vibrant world of Los Santos and become the character you've always dreamed of. Our server offers an immersive and diverse roleplay environment where your creativity knows no bounds.",
  url: "",
  ogImage: "",
  auth: {
    sidePanel: {
      ...
      quotes: [
        {
          id: 1,
          text: "God Help The Morally Bankrupt Planet Your Generation Have Left Us If You're The Good Guy.",
          owner: "Jimmy De Santa",
        },
        {
          id: 2,
          text: "God Help The Morally Bankrupt Planet Your Generation Have Left Us If You're The Good Guy.",
